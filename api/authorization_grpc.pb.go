...
const (
	AuthorizationService_Check_FullMethodName           = "/goacl.v1.AuthorizationService/Check"
	AuthorizationService_Expand_FullMethodName          = "/goacl.v1.AuthorizationService/Expand"
	AuthorizationService_ListPermissions_FullMethodName = "/goacl.v1.AuthorizationService/ListPermissions"
	AuthorizationService_BatchCheck_FullMethodName      = "/goacl.v1.AuthorizationService/BatchCheck"
)
...
func (c *authorizationServiceClient) Expand(ctx context.Context, in *ExpandRequest, opts ...grpc.CallOption) (*ExpandResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExpandResponse)
	err := c.cc.Invoke(ctx, AuthorizationService_Expand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthorizationServiceServer) Expand(context.Context, *ExpandRequest) (*ExpandResponse, error) {
...
func _AuthorizationService_Expand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExpandRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthorizationServiceServer).Expand(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationService_Expand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationServiceServer).Expand(ctx, req.(*ExpandRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthorizationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "goacl.v1.AuthorizationService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Expand",
			Handler:    _AuthorizationService_Expand_Handler,
		},
		{
